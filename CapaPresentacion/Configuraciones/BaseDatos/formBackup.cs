...
namespace CapaPresentacion
{
    public partial class formBackup : Form
    {
		...
		public void executa()
		{
			string miCarpeta = "backup_SGF_" + DateTime.Now.Day + "_" + (DateTime.Now.Month) + "_" + DateTime.Now.Year + "_" + Convert.ToDateTime(DateAndTime.TimeOfDay).Hour + "_" + Convert.ToDateTime(DateAndTime.TimeOfDay).Minute;
